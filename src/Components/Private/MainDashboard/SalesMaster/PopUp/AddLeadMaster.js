...
const AddLeadMaster = ({ onAddLead, onClose }) => {
  ...
  const products = ['surveillance System', 'Access Control System', 'TurnKey Project', 'Alleviz', 'CafeLive', 'WorksJoy', 'WorksJoy Blu', 'Fire Alarm System', 'Fire Hydrant System', 'IDS', 'AI Face Machines', 'Entrance Automation', 'Guard Tour System', 'Home Automation', 'IP PA and Communication System', 'CRM', 'Security Systems', 'KMS', 'VMS', 'Boom Barriers System', 'Tripod System', 'Flap Barriers System', 'EPBX System', 'CMS', 'Lift Eliviter System', 'AV6', 'Walky Talky System'];  
